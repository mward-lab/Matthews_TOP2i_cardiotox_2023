...
mitopg <- plot_grid(densityMTXsp, MtxBplot, Mtxgenesp_example, nrow = 1) 


Daunpg <- plot_grid(densityDNRsp, DnrBplot, Dnrgenesp_example, nrow = 1)
#, rel_heights = c(.8,2,1), rel_widths=c(1,1.5,2),scale=c(1,1,0.8))
Doxopg <- plot_grid(densityDOXsp, DoxBplot, Doxgenesp_example, nrow = 1)
#, rel_heights = c(.8,2,1), rel_widths=c(1,1.5,2),scale=c(1,1,0.8))
Epipg <- plot_grid(densityEPIsp, EpiBplot, Epigenesp_example, nrow = 1)
#, rel_heights = c(.8,1.5,1), rel_widths=c(1,1.5,2),scale=c(1,1,0.8))
