...
densityDOXsp <- toplist24hr %>% 
  ...
  theme(
    theme(     axis.title = element_text(size = 10, color = "black"),     axis.ticks = element_line(size = 1.5),     axis.text = element_text(size = 10, color = "black", angle = 0))
    axis.ticks = element_line(size = 1.5),
    axis.text = element_text(size = 8, color = "black", angle = 0))
...
DnrBplot <- toplist24hr %>% 
  ...
  geom_boxplot(aes(fill=id))+
  xlab(" ")+
  ylab("DNR specific adj.P.V <0.01\n n = 112")+
  theme_classic()+
  guides(fill= FALSE)+
  fill_palette(palette = drug_palNoVeh)+
  theme(
...
EpiBplot <- toplist24hr %>% 
  ...
  geom_boxplot(aes(fill=id))+
  xlab(" ")+
  ylab("EPI specific adj.P.V <0.01\n n = 84")+
  theme_classic()+
  guides(fill= FALSE)+
  fill_palette(palette = drug_palNoVeh)+
  theme(
...
mitopg <- plot_grid(densityMTXsp, MtxBplot, Mtxgenesp_example, nrow = 1, rel_heights = c(.8,2,1), rel_widths=c(1.2,1,1.5),scale=c(1,0.8,0.8))
