...
```{r Fig S3, message=FALSE, warning=FALSE, eval=FALSE,echo=TRUE}
...
### Fig. S10
```{r Fig S10 Drug specific genes, eval=FALSE, fig.height=8.5, fig.width=12, message=FALSE, warning=FALSE, include=FALSE}
...
### Fig. S12
```{r Fig S12 Cormotif, eval=FALSE, include=FALSE}
...
```{r Fig S13 GO Cormotif, echo=FALSE, fig.height=14, fig.width=8, out.height="80%"}
...
### Fig. S15
```{r Fig S15,fig.height=3, fig.width=14}
