...
### Fig. S10
```{r Fig S10 Drug specific genes, fig.height=8.5, fig.width=12, message=FALSE, warning=FALSE}
...
```{r Fig S12 GO Cormotif, echo=FALSE, fig.height=14, fig.width=8, out.height="80%"}
