...
I found `rlength(intersect(DOXtop_down$SYMBOL, reyes_setA$HGNC))` down regulated DEGS in my data set that intersected with Set A.  A closer look yielded NPPB to be the only down-regulated DEG that intersected with SetA from the Reyes paper.
