...
list_snp_IDS <- readRDS("output/SNP_list_ID.RDS")
...
# my_attributes <- c('entrezgene_id', 'ensembl_gene_id', 'hgnc_symbol')
# Knowles_S13 <- getBM(attributes = my_attributes,
#                      filters ="ensembl_gene_id",
#                      values =Knowles_S13$gene,
#                      mart = ensembl)
# 
# write.csv(Knowles_S13,"output/Knowles_S13.csv")
