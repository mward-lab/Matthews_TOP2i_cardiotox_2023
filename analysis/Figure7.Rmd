...
```{r Chrom reg heatmap,fig.width=6, fig.height=3}
...
cpm_boxplot(cpmcounts,GOI='23522',"Dark2",drug_pal_fact,
...
```{r logcpm kdm4b,fig.width=6, fig.height=3}

cpm_boxplot(cpmcounts,GOI='23030',"Dark2",drug_pal_fact,
