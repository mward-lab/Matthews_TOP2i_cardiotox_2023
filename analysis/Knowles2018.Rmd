---
title: "Analysis of Knowles QTL data"
author: "ERM"
date: "`r Sys.Date()`"
...
``` 
## function load
```{r cpmboxplot function, echo= TRUE}
cpm_boxplot <-
  function(cpmcounts,
           GOI,
           brewer_palette,
...
```{r Agrid plot, eval=TRUE,echo=TRUE}
...
```{r Bgrid plot, eval=TRUE,echo=TRUE, fig.width=12, fig.height=8.5}
...
#### grid 3 hour
```{r 3hour grid,eval=TRUE,echo=TRUE, fig.width=12, fig.height=8.5}
