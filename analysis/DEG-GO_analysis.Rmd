...
The analysis is based on all genes that passed the rowMeans\>0 from the previous page which are about 14084 genes expressed in my RNA-seq data.
...
```{r intial analysis DA3 and DA24, message=FALSE, warning=FALSE}
...
```{r DA 3v24 int, message=FALSE, warning=FALSE}
...
```{r intial analysis DX3, message=FALSE, warning=FALSE}
...
```{r intial analysis DX24 ,message=FALSE, warning=FALSE}
...
```{r intial analysis EP3, message = FALSE, warning = FALSE}
...
```{r intial analysis EP24 , message=FALSE, warning=FALSE}
...
```{r intial analysis MT3, message=FALSE, warning=FALSE}
...
```{r intial analysis MT24, message=FALSE, warning=FALSE}  
# ---------------------------------------------------------
#
...
```{r 3 hours, message=FALSE, warning=FALSE}
# total 3 ----------------------------------------------------------------
...
```{r GO DDEresp 3 hour genelist of SDEGs,  message=FALSE, warning=FALSE}
...
```{r GO DDEresp 24 hour genelist of SDEGs,  message = FALSE, warning = FALSE}
##No enrichment for DDE only resp!
...
```{r GO DDEM 3 hourlist of SDEGs, message=FALSE, warning=FALSE}
...
```{r GO DDEM 24 hour list of SDEGs,message=FALSE, warning=FALSE}
...
```{r GO DXsprespon$ENTREZID genelist of SDEGs, message=FALSE, warning=FALSE}
...
```{r no response cluster,  message=FALSE, warning=FALSE}
#
...
```{r GOBP dEGlong, fig.height=12, fig.width=8,message=FALSE, warning=FALSE}
