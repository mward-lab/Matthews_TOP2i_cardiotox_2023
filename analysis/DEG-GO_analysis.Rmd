...
MTgostres24sp <- readRDS("data/DEG-GO/MTgostres24.RDS")
...
# 3 and 24 hour sigDEGs (adj. p value <0.01)venndiagrams by treatment
...
#5155
DXsprespon<- list24totvenn$..counts..[[14]]
...
NoRespDEG <- setdiff(backGL ,complete$ENTREZID) #
#4593
