...
##this code check the directory and searches for the pattern, returning the full name of the file
...
#loop through the list of files and make a separate dataframe for each file under it's real name
...
```{r intial analysis, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
