---
title: "Figure 6: Chromatin regulators that mediate breast cancer sensitivity to ACs are enriched amongst early TOP2i response genes. "
author: "ERM"
date: "`r Sys.Date()`"
output:
  html_document: 
...
## Figure 6: Chromatin regulators that mediate breast cancer sensitivity to ACs are enriched amongst early TOP2i response genes. 
...
More analysis of the Seoane data is at [this link](https://mward-lab.github.io/Matthews_TOP2i_cardiotox_2023/Seoane_chrom.html)

### B.  Log~2~ cpm of *KAT6B*


```{r logcpm kat6b, fig.width=6, fig.height=4}
