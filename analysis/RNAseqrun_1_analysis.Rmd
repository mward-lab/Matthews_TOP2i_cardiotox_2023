...
```{r library loading, warning=FALSE, echo=FALSE, message=FALSE}
...
dim(filter_test)
##this gives me 14448 genes left using a minimum of 10 read counts in a 
...
### and yet another filter method



condition <- row_means > 0
keep <- filterByExpr(mymatrix, condition)
filt_matrix <- mymatrix[keep, , keep.lib.sizes=FALSE]
dim(filt_matrix)

## now I have 16
lcpm <- cpm(mymatrix, log=TRUE)
