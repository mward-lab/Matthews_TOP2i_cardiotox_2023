...
```{r boxplot counts per sample, echo=FALSE, fig.height=5, fig.width=7, message=FALSE, warning=FALSE}
...
```{r individual PCA by drug and time steps, echo=FALSE, warning=FALSE, fig.height=8, fig.width= 5}
...
```{r Differential expression3 contrasts, eval = TRUE ,echo=FALSE}
# Make contrasts
#cm <- makeContrasts(
...
for(i in seq_along(siglist)) {
  fnl <- paste0("C:/Program Files/R_WD/Cardiotoxicity/data/",names(siglist)[i],".txt")
    write.csv(siglist[i], fnl, col.names = TRUE, row.names =FALSE, sep="") 
             
}

#write.csv(names(siglist),"C:/Program Files/R_WD/Cardiotoxicity/data/siglist.txt", col.names = FALSE,row.names = FALSE)
```
...
```{r prcompish stuff, echo=FALSE, warning=FALSE}
...
volcanosig(V.DA24.top, 0.01,0)
volcanosig(V.DA.top, 0.01,20)+ ggtitle("Daunorubicin 3 hour")
volcanosig(V.DA24.top, 0.01,10)+ ggtitle("Daunorubicin 24 hour")
volcanosig(V.DX.top, 0.01,10)+ ggtitle("Doxorubicin 3 hour")
volcanosig(V.DX24.top, 0.01,10)+ ggtitle("Doxorubicin 24 hour")
volcanosig(V.EP.top, 0.01,10)+ ggtitle("Epirubicin 3 hour")
volcanosig(V.EP24.top, 0.01,10)+ ggtitle("Epirubicin 24 hour")
volcanosig(V.MT.top, 0.01,10)+ ggtitle("Mitoxatrone 3 hour")
volcanosig(V.MT24.top, 0.01,10)+ ggtitle("Mitoxatrone 24 hour")
volcanosig(V.TR.top, 0.01,10)+ ggtitle("Trastuzumab 3 hour")
volcanosig(V.TR24.top, 0.01,10)+ ggtitle("Trastuzumab 24 hour")
