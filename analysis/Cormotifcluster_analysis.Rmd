...
```{r NR genes at 24 hours, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}

##here I want to find out 3 hour intersection and 24 hour intersection genes are comparable to  TI union
...
```{r intersection of Top2Bi 24h, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```
```{r intersection between 24h and TI sets, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r intersection of all sets TI ER LR, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
