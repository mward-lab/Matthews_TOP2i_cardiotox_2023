...
#top2bi_LR <-  read_csv("data/cormotif_LR_respset.txt")
# colnames(top2bi_LR) <-"ENTREZID"
...
# top2bi_ER <-  read_csv("data/cormotif_ER_respset.txt")
# colnames(top2bi_ER) <-"ENTREZID"
# length(top2bi_ER$ENTREZID)
