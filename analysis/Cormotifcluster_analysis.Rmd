...
```{r echo=TRUE, r,file='code/corMotifcustom.R'}
...
```{r cormotif_inital analysis, eval= TRUE, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r piechart and lollipop, include=FALSE}
#make data frame
Set <- c("EAR", "ESR","LR", "NR")
...
```{r noresponse data motif1, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Top2iLR motif set, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Top2iER set motif, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r time independent, echo=TRUE, message=FALSE, warning=FALSE  }
...
```{r all go in one loooooong frame, eecho=TRUE, fig.height=16, fig.width=8, message=FALSE, warning=FALSE}
...
```{r kegg break, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r clust1NR gene,echo=TRUE, message=FALSE, warning=FALSE}
...
```{r clustESR,echo=TRUE, message=FALSE, warning=FALSE}
# 
# motif_TI_rep <-
...
```{r motif_LR, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r motif ER, echo=TRUE, message=FALSE, warning=FALSE}
# motif_ERrep <-
