...
```{r ZNF740 data, eval=TRUE, fig.height=3, fig.width=4, include=FALSE}
...
```{r RMI1 data, eval=TRUE, fig.height=3, fig.width=4, include=FALSE}
...
```{r SLC data, eval=TRUE, fig.height=3, fig.width=4, include=FALSE}
