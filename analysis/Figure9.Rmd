...
```{r ZNF740 data, eval=TRUE, fig.height=3, fig.width=4, include=TRUE}
...
```{r RMI1 data, eval=TRUE, fig.height=3, fig.width=4, include=TRUE}
...
```{r SLC data, eval=TRUE, fig.height=3, fig.width=4, include=TRUE}
