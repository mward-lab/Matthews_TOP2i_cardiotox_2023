...
# counts24hours <- as.data.frame(as.table(countstotal[,c(7:12,19:24,31:36,43:48,55:60, 67:72)]))
...
# colnames(counts24hours) <- c("ENTREZID", "Samples",  "Counts")
...
# write_rds(counts24hours, "data/counts24hours.RDS")
...
```
written summary so far:  pending T values sorting.
