...
write.csv(filcpm_matrix, "data/filtered_cpm_counts.csv")
...
efit2 <- eBayes(vfit)
#saveRDS(efit2,"data/efit2.RDS")


```

```{r Differential expression, echo=FALSE}
#efit2 <- readRDS("data/efit2.RDS")
# countstotal <- efit2$
...
saveRDS(siglist,"data/siglist.RDS")
...
### cormotif analysis [More In-depth](https://reneeisnowhere.github.io/Cardiotoxicity/Cormotifcluster_analysis.html)
```{r cormotif analysis info, eval=FALSE, include=FALSE}
library(Cormotif)
library(IRanges)
group_fac <- group1
...
# dim(gene_prob_tran)
#this info is done on the following scripts: Cormotifcluster_analysis_RMD
#Corrscripts.R and corMotifcustom.R
...
More analysis on corMotif (aka Baysian gene anaylsis can be found on this page:) [CorMotif](https://reneeisnowhere.github.io/Cardiotoxicity/Cormotifcluster_analysis.html)
...
v1 <- volcanosig(V.DA.top, 0.01,0)+ ggtitle("Daunorubicin 3 hour")
v2 <- volcanosig(V.DA24.top, 0.01,0)+ ggtitle("Daunorubicin 24 hour")+ylab("")
v3 <- volcanosig(V.DX.top, 0.01,0)+ ggtitle("Doxorubicin 3 hour")
v4 <- volcanosig(V.DX24.top, 0.01,0)+ ggtitle("Doxorubicin 24 hour")+ylab("")
v5 <- volcanosig(V.EP.top, 0.01,0)+ ggtitle("Epirubicin 3 hour")
v6 <- volcanosig(V.EP24.top, 0.01,0)+ ggtitle("Epirubicin 24 hour")+ylab("")
v7 <- volcanosig(V.MT.top, 0.01,0)+ ggtitle("Mitoxatrone 3 hour")
v8 <- volcanosig(V.MT24.top, 0.01,0)+ ggtitle("Mitoxatrone 24 hour")+ylab("")
v9 <- volcanosig(V.TR.top, 0.01,0)+ ggtitle("Trastuzumab 3 hour")
v10 <- volcanosig(V.TR24.top, 0.01,0)+ ggtitle("Trastuzumab 24 hour")+ylab("")
