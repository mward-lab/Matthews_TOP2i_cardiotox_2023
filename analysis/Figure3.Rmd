...
legendtop <- get_legend(PCA_plot_group)
PCA_plot_groupnl <- PCA_plot_group+theme(legend.position = "none")
PCA_plot_group
```
...
legendbot <- get_legend(Top2b + guides(fill="none"))
...
legend <- plot_grid(legendtop,legendbot,ncol=1)
legend
PCA_full_Figure <- plot_grid(PCA_plot_groupnl,legend,top2plots,nrow=1,rel_widths = c(7,1,6), rel_heights = c(1,1.1,.5),scale=c(1,.8,.9))
PCA_full_Figure
