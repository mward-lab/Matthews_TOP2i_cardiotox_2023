...
```{r figure1A, echo=TRUE, message=FALSE, warning=FALSE, dev='png'}
  knitr::include_graphics("data/Figure1-A.png")

```

![Intro Figure](C:/Program Files/R_WD/Cardiotoxicity/data/Figure1-A.png)
