...
chisq.test(chi_list4[,c('NR','LR')])
chisq.test(chi_list4[,c('NR','ER')])
chisq.test(chi_list4[,c('NR','TI')])
...
chisq.test(chi_list1[,c('NR','LR')])
chisq.test(chi_list1[,c('NR','ER')])
chisq.test(chi_list1[,c('NR','TI')])
