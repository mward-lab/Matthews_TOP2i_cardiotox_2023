...
Heatmap( as.matrix(ARRmat), name = "Arrhythmia chi square \n-log (p values)", cluster_rows = FALSE, cluster_columns = FALSE,col=col_fun1,column_names_rot = 0)
...
Heatmap( as.matrix(HFmat), name = "Heart Failure GWAS\n chi square -log p values", cluster_rows = FALSE, cluster_columns = FALSE,col = col_fun1,column_names_rot = 0)
...
Heatmap( as.matrix(CADmat), name = "Heart Failure GWAS\n chi square -log p values", cluster_rows = FALSE, cluster_columns = FALSE,col_fun1)
