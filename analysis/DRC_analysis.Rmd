...
pheatmap::pheatmap(slopecorr,cluster_rows=FALSE,cluster_cols = FALSE, main="slope")
# avgLD50 <- readRDS("data/avgLD50.RDS")
ld50corr <- cor(ld50_table)
corrplot::corrplot(ld50corr)
pheatmap::pheatmap(ld50corr , cluster_rows = FALSE, cluster_cols = FALSE, main="ld50")
