...
# plot_list_DRC <- list('DA2'=DA2,'DX2'=DX2,'EP2' =EP2 ,'MT2'=MT2,'TR2'=TR2,'VE2'=VE2)
# 
# saveRDS(plot_list_DRC,"data/plot_list_DRC.RDS")
```
...
# plot_intv_list <- list('DNR_intv'=DNR_intv,'DOX_intv'=DOX_intv,'EPI_intv' =EPI_intv ,'MTX_intv'=MTX_intv,'TRZ_intv'=TRZ_intv,'VEH_intv'=VEH_intv)
# # 
# saveRDS(plot_intv_list,"data/plot_intv_list.RDS")
for (each in 1:6){
  newdata <- DNR_intv %>% 
...
# #write.csv(LDfull, "data/Full_LD_rep.csv")
